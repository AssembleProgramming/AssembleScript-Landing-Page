            ...
            <div className="main-contest-page">
                ...
                <div className="contest-info">
                    <div className="col-left">
                        <p>Welcome to the <span id='codefinity'>"Codefinity Challenge"</span> of AssembleScript</p>
                        <p>This contest is sponsored by <a href="https://github.com/AssembleProgramming">Assemble Programming</a>.</p>
                    </div>
