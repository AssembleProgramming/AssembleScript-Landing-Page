...
import QuestionTwoCodeSnippets from './QuestionTwoCodeSnippets';
...
import QuestionTwo from './QuestionTwoCode';
import QuestionTwoTest from './QuestionTwoTestCases';

const ContestQuestionTwo = ({ user }) => {

  const isDisabledBtn = user[0].QUESTION_TWO_STATUS;
  const teamMail = user[0].TEAM_MAIL;

  let DEFAULTcode = QuestionTwo;
  ...
  const handleCorrectSubmission = async () => {
    ...
    try {
      const response = await fetch(`${SERVER_LINK}/submit-question-two`, {
        method: "POST",
        headers: {
          ...
          <div className="submission-status">
            <div className="submission-result-container">
              ...
              <div style={{
                ...
                {
                  user[0].QUESTION_TWO_STATUS === false
                    ?
...
export default ContestQuestionTwo;
